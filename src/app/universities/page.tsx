...
function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_50%_30%,rgba(26,109,255,0.14)_0%,transparent_60%)]" />
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_80%_20%,rgba(0,229,255,0.07)_0%,transparent_50%)]" />
      ...
      {/* Floating shapes */}
      <FloatingShape className="top-[12%] left-[8%] w-16 h-16" depth={3} mouseX={mouseX} mouseY={mouseY} delay={0}>
        <div className="w-full h-full rounded-full border border-cyan/10" />
      </FloatingShape>
      <FloatingShape className="top-[18%] right-[10%] w-3 h-3" depth={5} mouseX={mouseX} mouseY={mouseY} delay={0.3}>
        <div className="w-full h-full rounded-full bg-blue-start/30" />
      </FloatingShape>
      <FloatingShape className="bottom-[20%] left-[15%] w-12 h-12" depth={2} mouseX={mouseX} mouseY={mouseY} delay={0.5}>
        <div className="w-full h-full rounded-full border border-purple/15" />
      </FloatingShape>
      <FloatingShape className="bottom-[25%] right-[8%] w-2 h-2" depth={4} mouseX={mouseX} mouseY={mouseY} delay={0.2}>
        <div className="w-full h-full rounded-full bg-cyan/20" />
      </FloatingShape>
      ...
      >
        ...
        >
          ...
          <span className="text-sm text-text-secondary">
            ...
            <span className="text-text-primary font-medium">3 Continents</span>
          </span>
        </motion.div>
        ...
        <h1
          ref={headlineRef}
          className="text-4xl sm:text-5xl md:text-6xl lg:text-[5rem] font-heading font-bold text-text-primary leading-[1.08] tracking-tight mb-6"
        >
          ...
          {headlineParts[1].text.split("").map((char, i) => (
            <span
              key={`l2-${i}`}
              className="hero-char inline-block opacity-0 bg-gradient-to-r from-blue-start via-cyan to-blue-mid bg-clip-text text-transparent"
              style={{ display: char === " " ? "inline" : "inline-block" }}
            >
              {char === " " ? "\u00A0" : char}
            </span>
        ...
        {/* Divider */}
        <motion.div
          className="mx-auto w-20 h-px bg-gradient-to-r from-transparent via-cyan/50 to-transparent mb-6"
        ...
        >
          ...
          <span className="text-text-primary font-medium">accredited institutions</span>{" "}
          committed to academic excellence, ensuring your credentials carry{" "}
          <span className="text-text-primary font-medium">global recognition</span> and
        ...
        >
          {[
            { icon: Shield, label: "All Universities Accredited", color: "text-cyan" },
            ...
            <div key={item.label} className="flex items-center">
              {i > 0 && (
                <div className="hidden sm:block w-px h-8 bg-white/[0.08] mx-6" />
              )}
...
// ════════════════════════════════════════════
// 2. GLOBAL UNIVERSITY NETWORK (Interactive Map)
// ════════════════════════════════════════════
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-center">
          ...
          <div className="lg:col-span-2 space-y-4">
            {[
              ...
              <motion.div
                key={item.region}
                className="p-6 rounded-2xl bg-white/[0.03] border border-white/[0.08] hover:bg-white/[0.06] hover:border-white/[0.15] transition-all duration-500"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-10 max-w-3xl mx-auto">
          ...
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-3 rounded-xl bg-white/[0.04] border border-white/[0.1] text-text-primary text-sm placeholder:text-text-muted focus:outline-none focus:border-cyan/40 focus:bg-white/[0.06] transition-all duration-300"
            />
          </div>
          ...
          <select
            ...
            className="px-4 py-3 rounded-xl bg-white/[0.04] border border-white/[0.1] text-text-secondary text-sm focus:outline-none focus:border-cyan/40 appearance-none cursor-pointer"
          >
            {UNIVERSITY_REGIONS.map((region) => (
              <option key={region} value={region} className="bg-bg-surface text-text-primary">
                {region}
              </option>
            ))}
          </select>
          ...
          <select
            ...
            className="px-4 py-3 rounded-xl bg-white/[0.04] border border-white/[0.1] text-text-secondary text-sm focus:outline-none focus:border-cyan/40 appearance-none cursor-pointer"
          >
            <option value="All Programs" className="bg-bg-surface text-text-primary">All Programs</option>
            <option value="Honorary Doctorate" className="bg-bg-surface text-text-primary">Honorary Doctorate</option>
            <option value="DBA" className="bg-bg-surface text-text-primary">DBA</option>
            <option value="PhD" className="bg-bg-surface text-text-primary">PhD</option>
          </select>
        </div>
              ...
              >
                <Card className="p-0 h-full overflow-hidden">
                  ...
                  <div className="relative p-6 pb-4">
                    {/* Featured badge */}
                    {uni.featured && (
                      <div className="absolute top-4 right-4 flex items-center gap-1.5 px-3 py-1 rounded-full bg-gradient-to-r from-blue-start/20 to-cyan/20 border border-cyan/20">
                    ...
                    <div className="flex items-center gap-4 mb-4">
                      {/* University emblem */}
                      <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-start/20 to-cyan/10 border border-white/[0.08] flex items-center justify-center">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-1.5 text-sm text-text-muted mt-1">
                          ...
                          <span className="text-text-muted text-xs">Est. {uni.established}</span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="p-6 pt-4">
                    {/* Programs */}
                    <div className="mb-4">
                      <h4 className="text-[10px] text-text-muted uppercase tracking-wider mb-2 font-medium">
                        Available Programs
                      </h4>
                    ...
                    <div className="mb-5">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {uni.specializations.map((spec) => (
                          <span
                            key={spec}
                            className="text-xs px-3 py-1 rounded-lg bg-purple/10 text-purple border border-purple/20"
                          >
                            {spec}
                          </span>
                        ))}
        ...
        {filteredUniversities.length === 0 && (
          ...
          >
            ...
            <p className="text-text-muted text-lg mb-2">No universities found</p>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="space-y-8">
          {featured.map((uni, i) => (
            <motion.div
              key={uni.id}
              className="relative rounded-3xl overflow-hidden bg-white/[0.02] border border-white/[0.08] hover:border-white/[0.15] transition-all duration-700"
            ...
            >
              {/* Gradient accent bar */}
              <div className="h-1 bg-gradient-to-r from-blue-start via-cyan to-blue-mid" />

              <div className="grid grid-cols-1 lg:grid-cols-3 gap-0">
                {/* Left - Institution info */}
                <div className="lg:col-span-2 p-8 lg:p-12">
                  <div className="flex items-center gap-4 mb-6">
                    <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-blue-start/20 to-cyan/10 border border-white/[0.1] flex items-center justify-center">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        <span className="text-text-muted">{uni.location}</span>
                        <span className="text-white/20">|</span>
                        <span className="text-text-muted text-sm">Founded {uni.established}</span>
                      </div>
                    </div>
                  </div>

                  <p className="text-text-secondary leading-relaxed text-base mb-8 max-w-2xl">
                    {uni.fullDescription}
                  </p>
                  ...
                  <div className="flex flex-wrap gap-3 mb-8">
                    {uni.programs.map((prog) => (
                      <div
                        key={prog}
                        className="flex items-center gap-2 px-4 py-2 rounded-xl bg-blue-start/10 border border-blue-start/20"
                      >
                        <GraduationCap className="w-4 h-4 text-blue-mid" />
                        <span className="text-sm text-blue-mid font-medium">{prog}</span>
                      </div>
                    ))}
                  </div>
                ...
                <div className="p-8 lg:p-12 lg:border-l border-t lg:border-t-0 border-white/[0.06] bg-white/[0.01]">
                  <h4 className="text-xs text-text-muted uppercase tracking-wider mb-6 font-medium">
                    Institution Details
                  </h4>

                  <div className="space-y-5">
                    <div>
                      <div className="text-xs text-text-muted mb-1">Accreditation</div>
                    ...
                    <div>
                      <div className="text-xs text-text-muted mb-1">Region</div>
                      <span className="text-text-primary text-sm">{uni.region}</span>
                    </div>

                    <div>
                      <div className="text-xs text-text-muted mb-1">Established</div>
                      <span className="text-text-primary text-sm">{uni.established}</span>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {uni.specializations.map((spec) => (
                          <span
                            key={spec}
                            className="text-[10px] px-2 py-1 rounded-md bg-purple/10 text-purple"
                          >
                            {spec}
                          </span>
                        ))}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="collab-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {COLLABORATION_MODEL.map((item, i) => {
            ...
            return (
              <div
                key={item.title}
                className="collab-card group relative p-6 rounded-2xl bg-white/[0.03] border border-white/[0.08] hover:bg-white/[0.06] hover:border-white/[0.15] transition-all duration-500 hover:-translate-y-1"
              >
                {/* Step number */}
                <div className="absolute top-4 right-4 text-xs text-text-muted/30 font-heading font-bold">
                  0{i + 1}
                </div>

                {/* Icon */}
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-purple/20 to-blue-start/20 border border-white/[0.08] flex items-center justify-center mb-5 group-hover:shadow-[0_0_20px_rgba(123,47,247,0.15)] transition-shadow duration-500">
        ...
        <div className="hidden lg:flex items-center justify-center mt-12">
          <div className="flex items-center gap-3">
            ...
            <div className="px-5 py-2.5 rounded-full bg-white/[0.04] border border-white/[0.08]">
              <span className="text-sm text-text-muted">
                All degrees conferred directly by{" "}
                <span className="text-text-primary font-medium">partner universities</span>
              </span>
            </div>
...
function AccreditationSection() {
  ...
  return (
    <section ref={sectionRef} className="relative py-20 lg:py-28 overflow-hidden">
      <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-white/[0.06] to-transparent" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] rounded-full bg-cyan/[0.03] blur-[120px]" aria-hidden="true" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="accred-header text-center mb-14">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-heading font-bold text-text-primary mb-5">
            Accreditation &{" "}
            <span className="bg-gradient-to-r from-cyan to-blue-mid bg-clip-text text-transparent">
              Recognition
            </span>
          </h2>
          <p className="text-text-secondary max-w-2xl mx-auto text-lg">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {ACCREDITATIONS.map((accred, i) => (
            <motion.div
              key={accred.name}
              className="relative p-6 rounded-2xl bg-white/[0.03] border border-white/[0.08] hover:bg-white/[0.06] hover:border-cyan/20 transition-all duration-500 text-center group"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            >
              {/* Badge icon */}
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-cyan/20 to-blue-start/10 border border-white/[0.1] flex items-center justify-center mx-auto mb-4 group-hover:shadow-[0_0_25px_rgba(0,229,255,0.12)] transition-shadow duration-500">
              ...
              <span className="inline-block text-[10px] px-3 py-1 rounded-full bg-cyan/10 text-cyan border border-cyan/20">
                {accred.region}
              </span>
            </motion.div>
          ))}
        ...
        <div className="max-w-3xl mx-auto text-center">
          <div className="p-8 rounded-2xl bg-gradient-to-br from-white/[0.03] to-white/[0.01] border border-white/[0.08]">
            <Shield className="w-8 h-8 text-cyan mx-auto mb-4" />
            <p className="text-text-secondary leading-relaxed">
              Techversity.ai works exclusively with universities that hold{" "}
              <span className="text-text-primary font-medium">recognized accreditation</span>.
              ...
              <span className="text-text-primary font-medium">exclusively by the university</span>.
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    <section ref={sectionRef} className="relative py-20 lg:py-28 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden" aria-hidden="true">
        ...
        />
        <div
          className="absolute w-[500px] h-[350px] rounded-full opacity-[0.06]"
          style={{
            background: "radial-gradient(ellipse, #00e5ff 0%, transparent 70%)",
            bottom: "10%",
            right: "10%",
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
          {IMPACT_STATS.map((stat, i) => (
            <motion.div
              key={stat.label}
              className="text-center p-6 rounded-2xl bg-white/[0.03] border border-white/[0.08] hover:bg-white/[0.06] hover:border-white/[0.15] transition-all duration-500"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            >
              ...
              <div className="text-[10px] text-text-muted uppercase tracking-widest leading-tight">
                {stat.label}
              </div>
            </motion.div>
          ))}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {benefits.map((benefit, i) => (
              <motion.div
                key={benefit.title}
                className="p-5 rounded-xl bg-white/[0.03] border border-white/[0.08] hover:bg-white/[0.06] hover:border-orange/20 transition-all duration-500"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ delay: i * 0.08 }}
              >
                ...
                <h3 className="text-sm font-heading font-semibold text-text-primary mb-1.5">
                  {benefit.title}
                </h3>
      ...
      <div className="final-cta-content relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-10 text-sm text-text-muted">
          <div className="flex items-center gap-2">
            ...
            <span>
              <strong className="text-text-primary">100%</strong> Accredited Partners
            </span>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <span>
              <strong className="text-text-primary">12+</strong> Countries Served
            </span>
          </div>
        </div>
      </div>
  ...
  return (
    <section className="py-12 border-t border-white/[0.05]">
      <div className="max-w-3xl mx-auto px-6 text-center">
        <p className="text-xs text-text-muted leading-relaxed opacity-60">
